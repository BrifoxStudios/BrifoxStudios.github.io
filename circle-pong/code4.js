...
gdjs.PongCode.GDbackObjects1= [];
gdjs.PongCode.GDbackObjects2= [];
gdjs.PongCode.GDbackObjects3= [];
gdjs.PongCode.GDbackObjects4= [];
...
gdjs.PongCode.condition4IsTrue_0 = {val:false};
gdjs.PongCode.condition5IsTrue_0 = {val:false};
...
gdjs.PongCode.condition4IsTrue_1 = {val:false};
gdjs.PongCode.condition5IsTrue_1 = {val:false};
...
gdjs.PongCode.condition4IsTrue_2 = {val:false};
gdjs.PongCode.condition5IsTrue_2 = {val:false};
...
gdjs.PongCode.condition4IsTrue_3 = {val:false};
gdjs.PongCode.condition5IsTrue_3 = {val:false};
...
{for(var i = 0, len = gdjs.PongCode.GDBallObjects2.length ;i < len;++i) {
    gdjs.PongCode.GDBallObjects2[i].addForceTowardObject((gdjs.PongCode.GDPaddleObjects2.length !== 0 ? gdjs.PongCode.GDPaddleObjects2[0] : null), 250, 1);
}
...
{
gdjs.PongCode.condition2IsTrue_1.val = gdjs.evtsExt__Gamepads__C_Axis_pushed.func(runtimeScene, 1, "LEFT", "LEFT", (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined));
if( gdjs.PongCode.condition2IsTrue_1.val ) {
    gdjs.PongCode.conditionTrue_1.val = true;
}
}
{
gdjs.PongCode.condition3IsTrue_1.val = gdjs.evtsExt__Gamepads__C_Button_pressed.func(runtimeScene, 1, "CLICK_STICK_LEFT", (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined));
if( gdjs.PongCode.condition3IsTrue_1.val ) {
    gdjs.PongCode.conditionTrue_1.val = true;
}
}
{
gdjs.PongCode.condition4IsTrue_1.val = gdjs.evtsExt__Gamepads__C_Button_pressed.func(runtimeScene, 2, "CLICK_STICK_LEFT", (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined));
if( gdjs.PongCode.condition4IsTrue_1.val ) {
    gdjs.PongCode.conditionTrue_1.val = true;
}
}
{
...
{
gdjs.PongCode.condition2IsTrue_1.val = gdjs.evtsExt__Gamepads__C_Axis_pushed.func(runtimeScene, 1, "RIGHT", "RIGHT", (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined));
if( gdjs.PongCode.condition2IsTrue_1.val ) {
    gdjs.PongCode.conditionTrue_1.val = true;
}
}
{
gdjs.PongCode.condition3IsTrue_1.val = gdjs.evtsExt__Gamepads__C_Button_pressed.func(runtimeScene, 1, "CLICK_STICK_RIGHT", (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined));
if( gdjs.PongCode.condition3IsTrue_1.val ) {
    gdjs.PongCode.conditionTrue_1.val = true;
}
}
{
gdjs.PongCode.condition4IsTrue_1.val = gdjs.evtsExt__Gamepads__C_Button_pressed.func(runtimeScene, 2, "CLICK_STICK_RIGHT", (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined));
if( gdjs.PongCode.condition4IsTrue_1.val ) {
    gdjs.PongCode.conditionTrue_1.val = true;
}
}
...
{
{gdjs.PongCode.conditionTrue_1 = gdjs.PongCode.condition1IsTrue_0;
gdjs.PongCode.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(8906748);
}
}}
if (gdjs.PongCode.condition1IsTrue_0.val) {
...
{
{gdjs.PongCode.conditionTrue_1 = gdjs.PongCode.condition1IsTrue_0;
gdjs.PongCode.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(8908988);
}
}}
if (gdjs.PongCode.condition1IsTrue_0.val) {
...
};gdjs.PongCode.mapOfGDgdjs_46PongCode_46GDbackObjects1Objects = Hashtable.newFrom({"back": gdjs.PongCode.GDbackObjects1});
gdjs.PongCode.eventsList8 = function(runtimeScene) {
...
gdjs.copyArray(runtimeScene.getObjects("back"), gdjs.PongCode.GDbackObjects1);

gdjs.PongCode.condition0IsTrue_0.val = false;
gdjs.PongCode.condition1IsTrue_0.val = false;
{
gdjs.PongCode.condition0IsTrue_0.val = gdjs.evtTools.input.cursorOnObject(gdjs.PongCode.mapOfGDgdjs_46PongCode_46GDbackObjects1Objects, runtimeScene, true, false);
}if ( gdjs.PongCode.condition0IsTrue_0.val ) {
{
gdjs.PongCode.condition1IsTrue_0.val = gdjs.evtTools.input.isMouseButtonReleased(runtimeScene, "Left");
}}
if (gdjs.PongCode.condition1IsTrue_0.val) {
...
gdjs.PongCode.GDbackObjects1.length = 0;
gdjs.PongCode.GDbackObjects2.length = 0;
gdjs.PongCode.GDbackObjects3.length = 0;
gdjs.PongCode.GDbackObjects4.length = 0;
...
gdjs.PongCode.eventsList8(runtimeScene);
return;
